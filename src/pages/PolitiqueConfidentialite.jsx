    ...
    <section className="section">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-10 text-ardoise-700 leading-relaxed">
          <div>
            <h2 className="font-display font-bold text-xl text-ardoise-900 mb-3">1. Introduction</h2>
            <p>
          ...
          <div>
            <h2 className="font-display font-bold text-xl text-ardoise-900 mb-3">2. Responsable du traitement</h2>
            <ul className="list-disc pl-6 space-y-1.5">
              <li><strong className="text-ardoise-900">Responsable :</strong> CELEXIA, SIREN <span className="tabular">939 306 429</span>, Nogent-sur-Marne</li>
              <li>
          ...
          <div>
            <h2 className="font-display font-bold text-xl text-ardoise-900 mb-3">3. Données collectées</h2>
            <p>Nous sommes susceptibles de collecter :</p>
            <ul className="list-disc pl-6 mt-3 space-y-1.5">
              <li>
                <strong className="text-ardoise-900">Données d’inscription :</strong> nom, raison
              ...
              <li>
                <strong className="text-ardoise-900">Données de navigation :</strong> adresse IP,
                type de navigateur, pages consultées, durée de visite, via la mesure d’audience
                et uniquement après votre consentement
              </li>
              <li>
                <strong className="text-ardoise-900">Données d’échange :</strong> informations
          ...
          <div>
            <h2 className="font-display font-bold text-xl text-ardoise-900 mb-3">4. Finalités du traitement</h2>
            <ul className="list-disc pl-6 space-y-1.5">
          ...
          <div>
            <h2 className="font-display font-bold text-xl text-ardoise-900 mb-3">5. Base légale</h2>
            <ul className="list-disc pl-6 space-y-1.5">
              <li><strong className="text-ardoise-900">Votre consentement</strong> pour les cookies de mesure d’audience</li>
              <li><strong className="text-ardoise-900">L’exécution de mesures précontractuelles et du contrat</strong> pour le traitement de votre inscription et de la relation qui en découle</li>
              <li><strong className="text-ardoise-900">Nos obligations légales</strong> pour la conservation des pièces comptables</li>
            </ul>
          </div>

          <div>
            <h2 className="font-display font-bold text-xl text-ardoise-900 mb-3">6. Durée de conservation</h2>
            <p>
          ...
          <div>
            <h2 className="font-display font-bold text-xl text-ardoise-900 mb-3">7. Vos droits</h2>
            <p>Conformément au RGPD, vous disposez des droits suivants :</p>
            <ul className="list-disc pl-6 mt-3 space-y-1.5">
              <li><strong className="text-ardoise-900">Accès :</strong> obtenir une copie de vos données</li>
              <li><strong className="text-ardoise-900">Rectification :</strong> corriger des données inexactes</li>
              <li><strong className="text-ardoise-900">Effacement :</strong> demander la suppression de vos données</li>
              <li><strong className="text-ardoise-900">Limitation :</strong> restreindre le traitement</li>
              <li><strong className="text-ardoise-900">Portabilité :</strong> recevoir vos données dans un format structuré</li>
              <li><strong className="text-ardoise-900">Opposition :</strong> vous opposer au traitement</li>
            </ul>
            <p className="mt-4">
          ...
          <div>
            <h2 className="font-display font-bold text-xl text-ardoise-900 mb-3">8. Cookies</h2>
            <p>
          ...
          <div>
            <h2 className="font-display font-bold text-xl text-ardoise-900 mb-3">9. Sous-traitants</h2>
            <ul className="list-disc pl-6 space-y-1.5">
              <li><strong className="text-ardoise-900">Vercel Inc.</strong> — hébergement du site</li>
              <li><strong className="text-ardoise-900">Google Analytics</strong> — mesure d’audience, après consentement</li>
            </ul>
          </div>

          <div>
            <h2 className="font-display font-bold text-xl text-ardoise-900 mb-3">10. Contact et réclamation</h2>
            <p>
