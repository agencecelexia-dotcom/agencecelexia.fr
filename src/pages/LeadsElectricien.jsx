...
const LeadsElectricien = () => {
  ...
  useJsonLd({
    ...
    '@type': 'Service',
    'name': 'Génération de Leads pour Électriciens',
    'description': 'Service d\'acquisition de clients qualifiés spécialisé pour les électriciens. Paiement au lead qualifié uniquement.',
    'provider': {
      '@type': 'Organization',
      'name': 'Agence Celexia'
    },
  ...
  const benefits = [
    {
      ...
      desc: 'Pannes électriques, disjoncteurs, recherche de panne - interventions rapides à forte marge',
    ...
    },
    {
      ...
      desc: 'Mise aux normes, tableaux électriques, rénovation complète - projets 3 000€ à 12 000€',
    ...
    },
    {
      ...
      desc: 'Smart home, éclairage connecté, volets roulants - marché en forte croissance',
    ...
    {
      title: 'Installation borne électrique',
      desc: 'Bornes de recharge véhicules électriques - demande explosive avec la transition écologique',
  ...
  const faqs = [
    {
      ...
      answer: 'Majoritairement des particuliers propriétaires avec des projets de mise aux normes, rénovation électrique, installation domotique ou bornes de recharge. Environ 30% de dépannages urgents et 70% de projets planifiés.'
    },
    {
      question: 'Combien de leads par mois puis-je espérer ?',
      answer: 'Cela dépend de votre zone et de votre budget. En moyenne, nos électriciens reçoivent entre 15 et 50 appels qualifiés par mois. Les zones péri-urbaines fonctionnent particulièrement bien pour ce métier.'
    },
    {
      question: 'Est-ce que je peux choisir les types de chantiers ?',
      answer: 'Oui absolument. Vous pouvez cibler uniquement les types d\'interventions qui vous intéressent : dépannage, rénovation, domotique, bornes électriques, etc. Nous adaptons les campagnes à vos préférences.'
    },
    {
      question: 'Comment ça marche concrètement ?',
      answer: 'Nous positionnons votre entreprise en #1 sur Google quand quelqu\'un cherche un électricien dans votre zone. Vous recevez un appel direct du client. Vous le convertissez. Vous ne payez QUE cet appel qualifié.'
    }
  ];
  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative pt-28 pb-16 md:pt-36 md:pb-24 px-4 md:px-6 overflow-hidden">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-amber-100/40 rounded-full blur-3xl -translate-y-1/4 translate-x-1/4" />
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <span className="tag mb-6 inline-block">Électriciens</span>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {benefits.map((benefit, i) => (
              <div key={i} className="card p-7 border-gray-200 group hover:border-amber-200 transition-all duration-300">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-amber-100 flex items-center justify-center text-amber-600 flex-shrink-0
                                 group-hover:bg-amber-600 group-hover:text-white transition-colors duration-300">
                    {benefit.icon}
                  </div>
      ...
      <section className="py-20 md:py-28 px-4 md:px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="font-display text-3xl md:text-4xl font-bold text-gray-900 tracking-tight">
              Un électricien qui a réussi avec notre système
            </h2>
          </div>
...
export default LeadsElectricien;
