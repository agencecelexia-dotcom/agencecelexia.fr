...
const LeadsMenuisier = () => {
  ...
  usePageMeta({
    title: 'Leads Menuisier | Agence Celexia',
    description: 'Obtenez des appels de clients qualifiés pour votre menuiserie. Paiement par lead, résultats rapides. Agence Celexia.',
  ...
  const benefits = [
    {
      ...
      icon: <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-3m-1 4l-3 3m0 0l-3-3m3 3V4" /></svg>
    },
    {
